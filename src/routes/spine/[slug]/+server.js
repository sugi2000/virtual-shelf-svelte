...
export function GET({ params }) {
	...
	const svg = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="100" height="100" class="spine">
		<rect width="420" height="300" fill="#000"></rect>
